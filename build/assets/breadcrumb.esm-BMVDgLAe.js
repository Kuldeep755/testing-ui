...
`,j=ae.extend({defaultProps:{__TYPE:"BreadCrumb",id:null,model:null,home:null,separatorIcon:null,style:null,className:null,children:void 0},css:{classes:ve,styles:ge}});function X(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);t&&(a=a.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),r.push.apply(r,a)}return r}function $(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?X(Object(r),!0).forEach(function(a){me(e,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):X(Object(r)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(r,a))})}return e}var he=l.memo(l.forwardRef(function(e,t){var r=te(),a=l.useContext(ne),o=j.getProps(e,a),N=l.useState(o.id),d=ye(N,2),m=d[0],v=d[1],g=l.useRef(null),h=j.setMetaData({props:o,state:{id:m}}),s=h.ptm,u=h.cx,q=h.isUnstyled;oe(j.css.styles,q,{name:"breadcrumb"});var k=function(n,i){if(i.disabled){n.preventDefault();return}i.command&&i.command({originalEvent:n,item:i}),i.url||(n.preventDefault(),n.stopPropagation())},M=function(n){var i=typeof window<"u"?window.location.pathname:"";return n===i?"page":void 0},K=function(){var n=o.home;if(n){if(n.visible===!1)return null;var i=n.icon,c=n.target,f=n.url,b=n.disabled,p=n.style,_=n.className,P=n.template,E=n.label,I=r({className:u("icon")},s("icon")),C=U.getJSXIcon(i,$({},I),{props:o}),G=r({href:f||"#",className:u("action"),"aria-disabled":b,"aria-current":M(f),target:c,onClick:function(A){return k(A,n)}},s("action")),Q=r({className:u("label")},s("label")),V=E&&l.createElement("span",Q,E),x=l.createElement("a",G,C,V);if(P){var Z={onClick:function(A){return k(A,n)},className:"p-menuitem-link",labelClassName:"p-menuitem-text",element:x,props:o};x=H.getJSXElement(P,n,Z)}var T=m+"_home",ee=r({id:T,className:u("home",{_className:_,disabled:b}),style:p},s("home"));return l.createElement("li",S({},ee,{key:T}),x)}return null},R=function(n){var i=m+"_sep_"+n,c=r({className:u("separatorIcon"),"aria-hidden":"true"},s("separatorIcon")),f=o.separatorIcon||l.createElement(se,c),b=U.getJSXIcon(f,$({},c),{props:o}),p=r({id:i,className:u("separator"),role:"separator"},s("separator"));return l.createElement("li",S({},p,{key:i}),b)},L=function(n,i){if(n.visible===!1)return null;var c=r({className:u("label")},s("label")),f=n.label&&l.createElement("span",c,n.label),b=r({href:n.url||"#",className:u("action"),target:n.target,"aria-current":M(n.url),onClick:function(C){return k(C,n)},"aria-disabled":n.disabled},s("action")),p=l.createElement("a",b,f);if(n.template){var _={onClick:function(C){return k(C,n)},className:"p-menuitem-link",labelClassName:"p-menuitem-text",element:p,props:o};p=H.getJSXElement(n.template,n,_)}var P=n.id||m+"_"+i,E=r({id:P,className:u("menuitem",{item:n}),style:n.style},s("menuitem"));return l.createElement("li",S({},E,{key:P}),p)},F=function(){if(o.model){var n=o.model.map(function(i,c){if(i.visible===!1)return null;var f=L(i,c),b=c===o.model.length-1?null:R(c),p=m+"_"+c;return l.createElement(l.Fragment,{key:p},f,b)});return n}return null};le(function(){m||v(ie())}),l.useImperativeHandle(t,function(){return{props:o,getElement:function(){return g.current}}});var D=K(),w=F(),W=R("home"),Y=r({className:u("menu")},s("menu")),z=r({id:o.id,ref:g,className:B(o.className,u("root")),style:o.style},j.getOtherProps(o),s("root"));return l.createElement("nav",z,l.createElement("ol",Y,D,D&&!!(w!=null&&w.length)&&W,w))}));he.displayName="BreadCrumb";export{he as B};
